function BoxFeares({ icon, text }) {
  return (
    <div className="p-[32px] h-[220px] rtl border-gradient rounded-[28px] flex flex-col gap-6 bg-[linear-gradient(137.34deg,rgba(7,4,43,0.16)_23.98%,rgba(112,113,122,0.16)_65.73%)]">
